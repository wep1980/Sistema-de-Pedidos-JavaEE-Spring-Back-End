 ...
 */
@Configuration
@Profile("dev")// Indica que todos os Beans que estiverem dentro dessa classe vão ser ativados apenas quando o profile de dev estiver ativo no application.properties

...
public class Endereco implements Serializable{
	 ...
	 */
	//@JsonBackReference // O endereço não pode serializar os clientes
	@JsonIgnore
	@ManyToOne // Muitos endereços para um cliente
	@JoinColumn(name = "cliente_id") // nome da chave estrangeira que referencia o cliente dentro da tabela endereco
	private Cliente cliente;
	
	@ManyToOne // Muitos endereços para uma cidade
	@JoinColumn(name = "cidade_id") // nome da chave estrangeira que referencia a cidade dentro da tabela endereco

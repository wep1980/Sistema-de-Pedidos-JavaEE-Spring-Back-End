...
public class Categoria implements Serializable{
	 ...
	 */
	//@JsonManagedReference // Resolve o problema de serialização dos produtos
	@ManyToMany(mappedBy = "categorias") /* Mapeamento para a lista de categoria na classe produto */
	private List<Produto> produtos = new ArrayList<Produto>(); /* Uma categoria tem muitos produtos ou nenhum produto, lista criada aqui */

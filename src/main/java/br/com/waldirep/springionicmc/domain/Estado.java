...
public class Estado implements Serializable{
	...
	@JsonIgnore
	@OneToMany(mappedBy = "estado") // Mapeamento do atributo estado criado na tabela cidade
	private List<Cidade> cidades = new ArrayList<Cidade>(); // Um estado tem muitas cidades, então a lista e criada aqui

...
/**
 * Classe que instancia o banco de dados H2 e insere DADOS
 * @author wepbi
 *
 */
@Service
public class DBService {
	...
	/**
	 * Método que instancia o banco de dados com os valores. 
	 * Banco de dados H2
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Waldir", "wepjavamail@gmail.com" , "08180009700" , TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("22552494", "990561880"));
		cli1.addPerfil(Perfil.ADMIN);
		
		Cliente cli2 = new Cliente(null, "Aline", "line@gmail.com" , "30398016003" , TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("11111111", "222222222"));
		
		Endereco e1 = new Endereco(null, "Rua flores", "271", "Apt 207", "Copacabana", "22041011", cli1, c1);
		
		Endereco e2 = new Endereco(null, "Rua santa clara", "300", "Apt 907", "Bairro peixoto", "22041011", cli1, c3);
		
		Endereco e3 = new Endereco(null, "Rua Doutor satamini", "104", "Apt 403", "Tijuca", "25041061", cli2, c3);
